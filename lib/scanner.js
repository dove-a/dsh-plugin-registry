'use strict'
// @dove-a/dsh-plugin-registry — 载体扫描器
...
const DEFAULT_CARRIERS = (dshHome) => [
  ...
  { name: '@dove-a/*', type: 'pkg', roots: [path.join(dshHome, 'profiles', 'web', 'node_modules', '@dove-a'), path.join(dshHome, 'profiles', 'web', 'node_modules', 'dsh-chat-window-fold')] },
